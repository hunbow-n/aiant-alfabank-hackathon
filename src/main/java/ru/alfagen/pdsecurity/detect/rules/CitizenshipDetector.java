...
public final class CitizenshipDetector implements Detector {
    ...
    private static final Pattern COUNTRY = Pattern.compile(
            "(?iu)(россия|рф|казахстан|беларусь|украина|германия|франция|сша|китай|индия|италия|испания|польша|грузия|армения|азербайджан|узбекистан|таджикистан|киргизия|молдова|латвия|литва|эстония|финляндия|швеция|норвегия|дания|нидерланды|бельгия|австрия|швейцария|чехия|словакия|венгрия|румыния|болгария|сербия|греция|турция|израиль|япония|корея|вьетнам|тайланд|бразилия|аргентина|мексика|канада|австралия)");
    ...
    public List<Candidate> detect(SourceText source, DetectionContext context) {
        ...
        while (m.find()) {
            Matcher c = COUNTRY.matcher(source.value());
